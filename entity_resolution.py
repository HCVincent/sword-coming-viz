...
class EntityResolver:
    ...
    EDITORIAL_DESCRIPTION_PATTERNS: tuple[str, ...] = (
        # "适合 / 可 / 能" + editorial verb
        '适合补强', '适合补足', '适合扩展', '适合增强', '适合支撑',
        '适合承接', '适合强化',
        '可补足', '可补强', '可扩展', '可增强',
        '能补足', '能扩展', '能增强', '能补齐', '能稳定承接',
        '有助于补齐',
        # "补X" editorial verbs (standalone)
        '补足经营', '补充陈平安', '补齐后段', '补足龙泉',
        '补足宁姚', '补足陆沉', '补足王朝',
        # "山上" meta-references
        '山上线', '山上势力', '山上人物', '山上支线',
        '山上女性', '山上强者', '山上大势', '山上宗门',
        # pipeline / annotation phrasing
        '前三季叙事中多次出现',
        '关系边', '边缘节点', '关系链', '关系层次',
        '群像质感', '群像线', '经营线', '日常线', '陪伴线',
        '角色层次', '圈层',
    )
